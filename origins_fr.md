...
- Alias : <!--Alias-->Origins<!--/Alias-->

<!--OriginItem-->

# <!--Name-->Allemand<!--/Name-->

- Alias : <!--Alias-->German<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Autriche, Bade, Bavière, Franconie, Hanovre, Hesse, Palatinat du Rhin, Saxe, Souabe, Thuringe, Wurtemberg, Wurtzbourg, etc.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->alémanique, bas allemand, bavarois, haut allemand.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Pragmatisme +1, Superstition +1.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Loi et Théologie.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Régionalisme<!--/Name-->
...
# <!--Name-->Anglo-Normand<!--/Name-->

- Alias : <!--Alias-->Anglo-Norman<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Angleterre, Normandie, Alençon, Maine, Guyenne.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->anglais, anglo-normand, français.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Foi +1, Pragmatisme +1.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Histoire et Persuasion.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Convaincu de sa supériorité<!--/Name-->
...
# <!--Name-->Bourguignon de par-deçà<!--/Name-->

- Alias : <!--Alias-->Dutch Burgundian<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Artois, Brabant, Flandre, Groningue, Hainaut, Liège, Luxembourg, Picardie, Utrecht.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->anglo-normand, français, thiois, vieux frison.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Pragmatisme +2.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Loi et Perspicacité.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Esprit rebelle<!--/Name-->
...
# <!--Name-->Bourguignon de par-delà<!--/Name-->

- Alias : <!--Alias-->Burgundian<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Bourgogne, Charolais, Franche- Comté, Jura, Nevers.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->alémanique, français.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Foi +1, Pragmatisme +1.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Commandement et Histoire.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Opportunisme<!--/Name-->
...
- Alias : <!--Alias-->Byzantine<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Chypre, Constantinople, Crète, Épire, Grèce, Rhodes, Thessalonique.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->byzantin, grec, ottoman, vieux bulgare.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Pragmatisme +1, Superstition +1.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Médecine et Sciences.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Porte de l’Orient<!--/Name-->
...
- Alias : <!--Alias-->Celt<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Bretagne, Cornouailles, Écosse, Irlande, pays de Galles.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->anglo-normand, breton, cornique, cymrique, français, gaélique, irlandais.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Superstition +2.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Mystères et Survie.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Connaissances anciennes<!--/Name-->
...
- Alias : <!--Alias-->French<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Anjou, Armagnac, Bar, Berry, Blois, Bourbon, Champagne, Dauphiné, Lorraine, Orléanais, Poitou, Touraine, etc.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->français, occitan.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Foi +2.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Médecine et Théologie.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Fils et filles de l’Église<!--/Name-->
...
# <!--Name-->Hanséatique<!--/Name-->

- Alias : <!--Alias-->Hanseatic<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Brandebourg, Frise, Holstein, Livonie, Mecklenburg, Prusse, Poméranie, Westphalie.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->anglo-normand, bas allemand, danois, vieux frison, vieux slave oriental.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Pragmatisme +1, Superstition +1.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Perspicacité et Persuasion.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Langage du commerce<!--/Name-->
...
- Alias : <!--Alias-->Hungarian<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Bosnie, Croatie, Hongrie, Slavonie, Slovaquie, Transylvanie.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->hongrois, ruthène, serbe, tchèque.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Foi +1, Superstition +1.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Dressage et Histoire.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Entre deux mondes<!--/Name-->
...
- Alias : <!--Alias-->Iberian<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Asturies, Castille, Galice, Leon, Navarre, Portugal.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->castillan, catalan, galaïco-portugais, léonais, navarro-aragonais.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Foi +2.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Investigation et Théologie.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Lutte contre l’hérésie<!--/Name-->
...
- Alias : <!--Alias-->Italian<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Abruzzes, États pontificaux, Ragusa, Toscane, Vénétie.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->dalmatien, italien, sabir, vénitien.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Foi +1, Pragmatisme +1.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Sciences et Supercherie.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Berceau de la Renaissance<!--/Name-->
...
- Alias : <!--Alias-->Moor<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Grenade, Maghreb.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->arabe, arabe andalou, castillan, sabir.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Foi +1, Pragmatisme +1.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Sciences et Théologie.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Tolérance religieuse<!--/Name-->
...
# <!--Name-->Méditerranéen<!--/Name-->

- Alias : <!--Alias-->Mediterranean<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Aragon, Languedoc, Naples, Sardaigne, Sicile.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->catalan, français, napolitain, navarro-aragonais, occitan.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Pragmatisme +1, Superstition +1.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Nature et Représentation.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Peuple de la mer<!--/Name-->
...
# <!--Name-->Montagnard<!--/Name-->

- Alias : <!--Alias-->Mountainfolk<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Savoie, Suisse, Tyrol, Valais.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->alémanique, français, haut allemand, occitan, piémontais.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Pragmatisme +1, Superstition +1.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Athlétisme et Intimidation.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Rigueurs du climat<!--/Name-->
...
- Alias : <!--Alias-->Provençal<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Corse, Ligurie, Lombardie, Nice, Piémont, Provence.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->génois, italien, occitan, piémontais, sabir.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Foi +1, Superstition +1.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Loi et Persuasion.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Carrefour des populations<!--/Name-->
...
# <!--Name-->Scandinave<!--/Name-->

- Alias : <!--Alias-->Scandinavian<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Danemark, Islande, Norvège, Schleswig, Suède.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->bas allemand, danois, finnois, norrois, suédois.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Pragmatisme +1, Superstition +1.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Intimidation et Mystères.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Héritier des vikings<!--/Name-->
...
# <!--Name-->Slave méridional<!--/Name-->

- Alias : <!--Alias-->South Slav<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Bosnie, Bulgarie, Moldavie, Serbie, Valachie.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->dalmatien, moldave, ruthène, serbe, valaque, vieux bulgare.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Foi +1, Pragmatisme +1.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Investigation et Survie.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Assimilation culturelle<!--/Name-->
...
# <!--Name-->Slave occidental<!--/Name-->

- Alias : <!--Alias-->West Slav<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Bohème, Mazovie, Moravie, Pologne, Silésie.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->bas allemand, polonais, tchèque.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Pragmatisme +2.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Loi et Mystères.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Humanisme<!--/Name-->
...
# <!--Name-->Slave oriental<!--/Name-->

- Alias : <!--Alias-->East Slav<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Lituanie, Moscovie, Novgorod, Pskov, Ruthénie, Tver.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->lituanien, ruthène, vieux prussien, vieux slave oriental.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Superstition +2.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Dressage et Nature.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Enfant des Domovoi<!--/Name-->
...
# <!--Name-->Teutonique<!--/Name-->

- Alias : <!--Alias-->Teutonic<!--/Alias-->

**Régions d’origine :** <!--RegionsOfOrigin-->Courlande, Estonie, Gotland, Livonie, Prusse.<!--/RegionsOfOrigin-->

**Langues principales :** <!--MainLanguages-->bas allemand, suédois, vieux prussien, vieux slave oriental.<!--/MainLanguages-->

**Aspirations :** <!--Aspirations-->Foi +1, Pragmatisme +1.<!--/Aspirations-->

**Compétences accessibles :** <!--AvailableSkills-->Histoire et Stratégie.<!--/AvailableSkills-->

<!--OriginFeatureItem-->

# Aptitude : <!--Name-->Tradition chevaleresque<!--/Name-->
